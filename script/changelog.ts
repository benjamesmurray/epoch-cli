...
Generates UPCOMING_CHANGELOG.md by running the epochcli changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for epochcli run (default: low)
      --quiet            Suppress epochcli command output unless it fails
