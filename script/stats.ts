...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/benjamesmurray/epoch-cli/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for benjamesmurray/epoch-cli...\n")
...
console.log("Fetching npm all-time downloads for @epoch-ai/cli...\n")
const npmDownloads = await fetchNpmDownloads("@epoch-ai/cli")
