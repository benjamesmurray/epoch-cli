...
- PR #13942: https://github.com/anomalyco/epoch/pull/13942

## Do Not Translate (Locale Additions)

- `Epoch CLI` (preserve casing in prose; keep `epoch` only when it is part of commands, package names, paths, or code)
- `Epoch CLI Zen`
- `Epoch CLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `epoch` in prose when referring to the product name; use `Epoch CLI`
