...
- PR #10018: https://github.com/anomalyco/epochcli/pull/10018
- PR #12935: https://github.com/anomalyco/epochcli/pull/12935

## Do Not Translate (Locale Additions)

- `Epoch CLI` (preserve casing in prose; keep `epochcli` only in commands, package names, paths, or code)
- `Epoch CLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
