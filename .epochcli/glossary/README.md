...
Use this folder for locale-specific translation guidance that supplements `.epochcli/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/epochcli/pull/12345

## Do Not Translate (Locale Additions)

- `Epoch CLI` (preserve casing)
