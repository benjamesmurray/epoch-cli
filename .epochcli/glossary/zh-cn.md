...
- PR #13942: https://github.com/anomalyco/epochcli/pull/13942

## Do Not Translate (Locale Additions)

- `Epoch CLI` (preserve casing in prose; keep `epochcli` only when it is part of commands, package names, paths, or code)
- `Epoch CLI Zen`
- `Epoch CLI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `epochcli` in prose when referring to the product name; use `Epoch CLI`
