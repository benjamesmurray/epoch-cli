...
- PR #15835: https://github.com/anomalyco/epochcli/pull/15835

## Do Not Translate (Locale Additions)

- `Epoch CLI` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `epochcli` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Epoch CLI` in prose, `epochcli` only for exact technical identifiers
...
- Avoid changing `epochcli` to `Epoch CLI` inside commands, URLs, package names, or code literals
