import { Slug } from "@epoch-ai/util/slug"
...
export namespace Session {
  ...
  export function plan(input: { slug: string; time: { created: number } }) {
    const base = Instance.project.vcs
      ? path.join(Instance.worktree, ".epochcli", "plans")
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@epochcli/Session") {}
