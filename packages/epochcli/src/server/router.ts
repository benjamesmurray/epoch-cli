...
export function WorkspaceRouterMiddleware(upgrade: UpgradeWebSocket): MiddlewareHandler {
  ...
  return async (c) => {
    const raw = c.req.query("directory") || c.req.header("x-epochcli-directory") || process.cwd()
    ...
    const workspaceParam = url.searchParams.get("workspace") || c.req.header("x-epochcli-workspace")
    ...
    headers.delete("x-epochcli-workspace")
