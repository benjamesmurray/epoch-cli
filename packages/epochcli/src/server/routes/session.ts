  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Epoch CLI sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Epoch CLI session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Epoch CLI session for interacting with AI assistants and managing conversations.",
    ...
    .patch(
      ...
      async (c) => {
        ...
        if (updates.yolo !== undefined) {
          await Session.setYolo({ sessionID, yolo: updates.yolo })
        }
