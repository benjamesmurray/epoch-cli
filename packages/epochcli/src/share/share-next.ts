import type * as SDK from "@epoch-ai/sdk/v2"
...
export namespace ShareNext {
  ...
  const disabled = process.env["EPOCHCLI_DISABLE_SHARE"] === "true" || process.env["EPOCHCLI_DISABLE_SHARE"] === "1"
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@epochcli/ShareNext") {}
