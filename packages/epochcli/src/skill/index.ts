...
export namespace Skill {
  ...
  const EPOCHCLI_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  const loadSkills = Effect.fnUntraced(function* (
    ...
    if (!Flag.EPOCHCLI_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of configDirs) {
      yield* scan(state, bus, dir, EPOCHCLI_SKILL_PATTERN)
    }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@epochcli/Skill") {}
