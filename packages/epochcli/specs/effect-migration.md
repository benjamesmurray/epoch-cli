...
Practical reference for new and migrated Effect code in `packages/epochcli`.
...
export namespace Foo {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@epochcli/Foo") {}
...
Tool tests should use the existing Effect helpers in `packages/epochcli/test/lib/effect.ts`:
