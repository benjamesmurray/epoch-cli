...
const modelsUrl = process.env.EPOCHCLI_MODELS_URL || "https://models.dev"
...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    define: {
      EPOCHCLI_VERSION: `'${Script.version}'`,
      EPOCHCLI_MIGRATIONS: JSON.stringify(migrations),
      OTUI_TREE_SITTER_WORKER_PATH: bunfsRoot + workerRelativePath,
      EPOCHCLI_WORKER_PATH: workerPath,
      EPOCHCLI_CHANNEL: `'${Script.channel}'`,
      EPOCHCLI_LIBC: item.os === "linux" ? `'${item.abi ?? "glibc"}'` : "",
    },
  })
