...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders EPOCHCLI_CALLER", () => {
    process.env["EPOCHCLI_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode EPOCHCLI_CALLER", () => {
    process.env["EPOCHCLI_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown EPOCHCLI_CALLER", () => {
    process.env["EPOCHCLI_CALLER"] = "unknown"
