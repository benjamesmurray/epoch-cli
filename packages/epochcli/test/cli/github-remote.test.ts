...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/epochcli.git")).toEqual({ owner: "sst", repo: "epochcli" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/epochcli")).toEqual({ owner: "sst", repo: "epochcli" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/epochcli.git")).toEqual({ owner: "sst", repo: "epochcli" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/epochcli")).toEqual({ owner: "sst", repo: "epochcli" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/epochcli.git")).toEqual({ owner: "sst", repo: "epochcli" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/epochcli")).toEqual({ owner: "sst", repo: "epochcli" })
})
